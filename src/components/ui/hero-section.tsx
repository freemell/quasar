      ...
      <div className="relative z-10 min-h-screen flex flex-col justify-between items-center px-8 py-12 md:px-16 md:py-20">
        ...
        <div className="text-center max-w-5xl mx-auto">
          ...
          >
            <div className="mb-4 md:mb-6">
              ...
              <span className="word" data-delay="3950"> </span>
              <span className="word" data-delay="4100">
                tips
              </span>
              <span className="word" data-delay="4250"> </span>
              <span className="word" data-delay="4400">
                to
              </span>
              <span className="word" data-delay="4550"> </span>
              <span className="word" data-delay="4700">
                any
              </span>
              <span className="word" data-delay="4850"> </span>
              ...
              <span className="word" data-delay="5450"> </span>
            ...
            <div
              ...
              style={{ color: colors[200] }}
            >
              <span className="word" data-delay="6050">
                Zero
              </span>
              <span className="word" data-delay="6200"> </span>
              <span className="word" data-delay="6350">
                fees,
              </span>
              <span className="word" data-delay="6500"> </span>
              <span className="word" data-delay="6650">
                instant
              </span>
              <span className="word" data-delay="6800"> </span>
              <span className="word" data-delay="6950">
                payments,
              </span>
              <span className="word" data-delay="7100"> </span>
              <span className="word" data-delay="7250">
                and
              </span>
              <span className="word" data-delay="7400"> </span>
              <span className="word" data-delay="7550">
                auto-pay
              </span>
              <span className="word" data-delay="7700"> </span>
              <span className="word" data-delay="7850">
                features
              </span>
              <span className="word" data-delay="8000"> </span>
              <span className="word" data-delay="8150">
                powered
              </span>
              <span className="word" data-delay="8300"> </span>
              <span className="word" data-delay="8450">
                by
              </span>
              <span className="word" data-delay="8600"> </span>
              <span className="word" data-delay="8750">
                x402.
              </span>
            </div>
          </h1>
        ...
        <div className="text-center">
          ...
          <h2
            ...
            style={{ color: colors[200] }}
          >
            <span className="word" data-delay="8900">
              Instant
            </span>
            <span className="word" data-delay="9050"> </span>
            <span className="word" data-delay="9200">
              tips,
            </span>
            <span className="word" data-delay="9350"> </span>
            <span className="word" data-delay="9500">
              seamless
            </span>
            <span className="word" data-delay="9650"> </span>
            <span className="word" data-delay="9800">
              integration,
            </span>
            <span className="word" data-delay="9950"> </span>
            <span className="word" data-delay="10100">
              enterprise-grade
            </span>
            <span className="word" data-delay="10250"> </span>
            <span className="word" data-delay="10400">
              security.
            </span>
          </h2>
          <div
        ...
        >
          <a
            href="/dashboard"
            className="px-8 py-3 rounded-2xl border border-white/10 bg-white/10 text-white backdrop-blur-sm hover:bg-white/20 transition-colors text-sm font-light tracking-tight"
          >
            View Profile
          </a>
          <a
            ...
            className="px-8 py-3 rounded-2xl border border-white/10 text-white/80 hover:bg-white/5 transition-colors text-sm font-light tracking-tight"
          >
            How it works
          </a>
        </div>
